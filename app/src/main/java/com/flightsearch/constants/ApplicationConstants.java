package com.flightsearch.constants;

public interface ApplicationConstants {

    public static final String MAIN_SHARE_PREFERENCE = "FLIGHT_SEARCH";
    public static final String BASE_SERVER_URL = "https://e2e3-87-116-135-141.ngrok-free.app";
    ...
    public static final String TRIPS_DATA = "TRIPS_DATA";
